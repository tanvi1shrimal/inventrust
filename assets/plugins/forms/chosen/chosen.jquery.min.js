(function() {
    ...
    n = function(t) {
        ...
        n.prototype.destroy = function() {
            e(this.container[0].ownerDocument).unbind("click.chosen", this.click_test_action);
        ...
        n.prototype.search_results_mousewheel = function(e) {
            var t;
            if (e.originalEvent) {
                t = -e.originalEvent.wheelDelta || e.originalEvent.detail
            }
            if (t != null) {
                e.preventDefault();
        ...
        n.prototype.activate_field = function() {
            ...
            this.container.parent('div').addClass("active");
        ...
        n.prototype.test_active_click = function(t) {
            ...
            if (n.length && this.container[0] === n[0]) {
